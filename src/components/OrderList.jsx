      ...
      <table className="min-w-full table-auto border text-sm text-gray-200">
        <thead>
          <tr className="bg-gray-800 text-xs tracking-wider text-gray-400">
            ...
            <th className="px-4 py-3 border border-gray-700">P/L %</th>
            <th className="px-4 py-3 border border-gray-700">Fee</th>
        ...
        <tbody>
          {orders.map((order) => (
            ...
            >
              ...
              <td
                className={`px-4 py-2 border border-gray-700 ${order.profitLossPercent >= 0 ? "text-green-400" : "text-red-400"
                  }`}
              >
                {Number(order.profitLossPercent).toFixed(2)}
              </td>
              <td className="px-4 py-2 border border-gray-700">{Number(order.fee).toFixed(2)}</td>
